...
def build_pdf_header(pdf)
  ...
  private
  def products_params
    params.require(:product).permit(:code, :name, :category, :cost,:price,:price2,:tax1_name, :tax1,:tax2_name,:tax2, :tax3_name,:tax3 ,:quantity,:reorder,:description,:comments,:company_id,:marca_id,:modelo_id,:products_category_id,:unidad,:ubicacion,:active,:numparte,:products_lines_id,:products_grupos_id,:unidad_id,:stock_active)
  end
