...
def reportes05
  ...
  def export2
    ...
    @facturas  = Factura.where("fecha>=? and fecha<=? and tipo =?","2019-09-01 00:00:00","2025-12-31 23:59:59","1")
     a = ""
    ...
    pdf.font "Helvetica" , :size => 6
     ...
     for  customerpayment_rpt in @customerpayment_rpt
        ...
        if lcCli == customerpayment_rpt.customer_id 
          ...
          if customerpayment_rpt.year_month.to_f >= 201901 and customerpayment_rpt.year_month.to_f <= 201903
          ...
          if customerpayment_rpt.year_month == '201912'       
