...
ActiveRecord::Schema.define(version: 20210623153246) do
  ...
  create_table "program_examen", force: :cascade do |t|
    t.datetime "fecha"
    t.string   "code"
    t.string   "processed"
    t.datetime "date_processed"
  ...
  create_table "program_exms", force: :cascade do |t|
    t.integer  "employee_id"
    t.string   "ind"
    t.string   "tr"
    t.string   "em"
